...
Create the concrete Factory in "src/Factory" folder, the concrete factory must include his own header, the sepcific reader header and specific model header.
